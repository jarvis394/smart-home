...
export type DeviceCapabilityRangeStateBrightness = {
  instance: 'brightness'
  range: Range
  value: number
}

export type DeviceCapabilityRangeStateTemperature = {
  instance: 'temperature'
  range: Range
  value: number
}

export type DeviceCapabilityRangeStateHumidity = {
  instance: 'humidity'
  range: Range
  value: number
}
...
export type DeviceCapabilityByType<T extends DeviceCapabilityType> = Extract<
